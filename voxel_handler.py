...
class VoxelHandler:
    ...
    def ray_cast(self):
        # start point
        x1, y1, z1 = self.app.player.position.location
        # end position
        x2, y2, z2 = self.app.player.position.location + self.app.player.position.forward * MAX_RAY_DIST
